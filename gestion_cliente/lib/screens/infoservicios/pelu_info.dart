...
class _PeluInfoState extends State<PeluInfo> with SingleTickerProviderStateMixin {
 ...
 final Color aguamarron = const Color(0xFFFF80AB);
  ...
  final List<Map<String, String>> clases = [
    ...
    {"title": "Tratamiento capilar", "image": "assets/images/tratamientocapilar.jpg"},
  ...
  final List<Map<String, String>> refuerzo = [
    ...
    {"title": "Personal especializado", "image": "assets/images/personalpelu.jpg"},
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      "Cuidamos tu imagen, potenciamos tu confianza",
                                      style: TextStyle(
                                        color: aguamarron,
                                        fontSize: 24,
                                        fontWeight: FontWeight.bold,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        boxShadow: [
                                          BoxShadow(
                                            color: aguamarron.withOpacity(0.25),
                                            blurRadius: 18,
                                            spreadRadius: 1,
                                          ),
                                        ],
