...
class _GimnasioInfoState extends State<GimnasioInfo>  with SingleTickerProviderStateMixin {
 ...
 final Color amarillo = Color(0xFFFFF176);
  ...
  final List<Map<String, String>> refuerzo = [
    ...
    {"title": "Entrenadores personales", "image": "assets/images/entrenador.jpg"},
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      "Mejora tu salud, ponte en forma",
                                      style: TextStyle(
                                        color: amarillo,
                                        fontSize: 24,
                                        fontWeight: FontWeight.bold,
